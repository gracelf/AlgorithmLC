 ...
 *
 */
public class LC269AlienDictionary_dfs_still_wrong_edgerCase {
    ...
    public String alienOrder(String[] words) {
        ...
        boolean isValid = buildGraph(graph, words, allChar);
        if (!isValid) {
            return "";
        }
        for (int i = 0; i < 26; i++) {
    ...
    private boolean buildGraph(List<List<Character>> graph, String[] words, Set<Character> allChar) {
        for (int i = 0; i < 26; i++) {
    ...
    public static void main(String[] args) {
        LC269AlienDictionary_dfs_still_wrong_edgerCase solution = new LC269AlienDictionary_dfs_still_wrong_edgerCase();
